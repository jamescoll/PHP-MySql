...
else
{
	...
	//sample
	//this is to muppet-proof the site against people putting whatever value they like in the URL
	$currentTrack = 100;
}
...
<div id="wrap">
	...
	<div id="leftside">
		...
		<ul class="avmenu">
			...
			<li><a class="current" href="media.php">Audio</a></li>
    ...
    <hr />
	    ...
	    <table id="playlist1" width="90%" summary="An interactive playlist inspired by the iTunes playlist of Craig Gannell.">
            ...
            <?php do { ?>
	            ...
	            <tr onclick="DoNav('media.php?trackId=<?php echo $row_Recordset1['trackId']; ?>')">
        ...
        <!-- this crappy java player was necessitated by i) the refusal of ie9/firefox to play ball with mp3 ii) the refusal of ogg to load in other browsers and iii) a genuine lack of fellowship in the browser/audio world  Yay! -->
    <hr />
    <h3> Now Playing - <em><?php echo $row_Recordset2['trackTitle']; ?></em></h3>
    <h5> Please allow track a moment to load </h5>
	<h5> If experiencing problems please click <a href="chrome_media.php">here</a> for a HTML5 based player. </h5>
    <hr />
    
    <div id="audioplayer">
    <audio src="<?php echo $row_Recordset2['samplePath']; ?>"  preload="autoplay" />
    </div>
