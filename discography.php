...
$query_Recordset1 = "SELECT albumId, albumTitle, albumReleaseYear, albumLabel, albumThumbnail, ratingImage, albumRatingAlt FROM albuminfo ORDER BY albumId ASC";
$Recordset1 = mysql_query($query_Recordset1, $Project01) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);

mysql_select_db($database_Project01, $Project01);
$query_Recordset2 = "SELECT linkinfo.linkUrl, linkinfo.linkHeader FROM linkinfo WHERE linkinfo.linkType = 0";
...
<h2>Sign In:</h2>
	...
	<? } ?>
      ...
      <div id="content">
        ...
        <h2>Discography</h2>
        <hr />
        <table id="discography">
          <tr>
            <th align="left">Year</th>
            <th align="left" colspan="2">Title</th>
            <th align="left">Label</th>
            <th align="left">AMG Rating</th>
          </tr>
          <?php do { ?>
            <tr onclick="DoNav('review.php?albumId=<?php echo $row_Recordset1['albumId']; ?>')">
            <td><?php echo $row_Recordset1['albumReleaseYear']; ?></td>
            <td class="tableimage"><img src="<?php echo $row_Recordset1['albumThumbnail']; ?>" width="50" height="50" alt="<?php echo $row_Recordset1['albumTitle']; ?>" /></td>
            <td><?php echo $row_Recordset1['albumTitle']; ?></td>
            <td><?php echo $row_Recordset1['albumLabel']; ?></td>
            <td><img src="<?php echo $row_Recordset1['ratingImage']; ?>" alt="<?php echo $row_Recordset1['albumRatingAlt']; ?>" /></td>
          </tr>
